...
BZG.achievements = (function () {
  ...
  var LIST = [
    ...
    },
    {
      ...
      check: function () { return BZG.storage.getLevel().level >= 5; }
    },
    {
    ...
    /* ---------- Progressao de nivel ---------- */
    { id: "lvl-10", icon: "🎖️", name: "Nível 10", desc: "Chegue ao nível 10", check: function () { return BZG.storage.getLevel().level >= 10; } },
    { id: "lvl-25", icon: "🎖️", name: "Nível 25", desc: "Chegue ao nível 25", check: function () { return BZG.storage.getLevel().level >= 25; } },
    { id: "lvl-50", icon: "🏅", name: "Nível 50", desc: "Chegue ao nível 50", check: function () { return BZG.storage.getLevel().level >= 50; } },
    { id: "lvl-75", icon: "🏅", name: "Nível 75", desc: "Chegue ao nível 75", check: function () { return BZG.storage.getLevel().level >= 75; } },
    { id: "lvl-100", icon: "👑", name: "Nível máximo", desc: "Chegue ao nível 100", check: function () { return BZG.storage.getLevel().level >= 100; } },
